...
Date.prototype.getWeek = function (t) {
    if (t) {
        var e = new Date(this.valueOf()), a = (this.getDay() + 6) % 7;
    ...
    function a(e, a) {
        var o = null != e.options[a] ? e.options[a] : null, i = null != e.locale[a] ? e.locale[a] : null;
    ...
    function o(e, n) {
        ...
        return t.each(l, function (e, a) {
            ...
            if (t.each(e.split(">"), function (t, a) {
                    var d, h = null;
                    if (d = /^(\d\d)-(\d\d)$/.exec(a)) h = new Date(n, parseInt(d[2], 10) - 1, parseInt(d[1], 10)); else if (d = /^(\d\d)-(\d\d)-(\d\d\d\d)$/.exec(a)) parseInt(d[3], 10) == n && (h = new Date(n, parseInt(d[2], 10) - 1, parseInt(d[1], 10))); else if (d = /^easter(([+\-])(\d+))?$/.exec(a)) h = r(n, d[1] ? parseInt(d[1], 10) : 0); else if (d = /^(\d\d)([+\-])([1-5])\*([0-6])$/.exec(a)) {
    ...
    function s(e, a, o, i) {
        e.stopPropagation();
        var a = t(a), n = a.closest(".cal-cell"), s = n.closest(".cal-before-eventlist"), r = n.data("cal-row");
    ...
    function r(t, e) {
        var a = t % 19, o = Math.floor(t / 100), i = t % 100, n = Math.floor(o / 4), s = o % 4, r = Math.floor((o + 8) / 25), l = Math.floor((o - r + 1) / 3), d = (19 * a + o - n - l + 15) % 30, h = Math.floor(i / 4), p = i % 4, c = (32 + 2 * s + 2 * h - d - p) % 7, u = Math.floor((a + 11 * d + 22 * c) / 451), m = d + c + 7 * u + 114, f = Math.floor(m / 31) - 1, y = m % 31 + 1;
    ...
    o.cache = {}, n.prototype.setOptions = function (e) {
        ...
        var e = t.split(":"), a = parseInt(e[0]), o = parseInt(e[1]), i = "";
        ...
        var a = this, o = parseInt(this.options.time_split), n = 60 / o, s = Math.min(n, 1);
        ...
        var d = e.hours * n - parseInt(r[1]) / o, h = 6e4 * o, p = new Date(this.options.position.start.getTime());
        ...
        c.setHours(l[0]), c.setMinutes(l[1]), e.all_day = [], e.by_hour = [], e.after_time = [], e.before_time = [], t.each(e.events, function (t, o) {
            var n = new Date(parseInt(o.start)), s = new Date(parseInt(o.end));
        ...
        var a = this.options.time_start.split(":"), o = parseInt(this.options.time_split), i = "" + (parseInt(a[0]) + t * Math.max(o / 60, 1)), n = "" + o * e;
        return this._format_hour(i.formatNum(2) + ":" + n.formatNum(2))
    }, n.prototype._week = function () {
        this._loadTemplate("week-days");
        var e = {}, o = parseInt(this.options.position.start.getTime()), i = parseInt(this.options.position.end.getTime()), n = [], s = this, r = a(this, "first_day");
        ...
        var i = {
            tooltip: "",
            cal: this
        }, n = this.options.classes.months.outmonth, s = this.options.position.start.getDay();
        ...
        switch (t.type(o)) {
            ...
            case"string":
                o.length && (n = function () {
                    var i = [], n = a.options.position.start, s = a.options.position.end, r = {
                        from: n.getTime(),
                        to: s.getTime(),
        ...
        if (!this.options.templates[e]) {
            ...
            t.ajax({
                ...
                a.options.templates[e] = _.template(t.replace("/*]]>*/", "").replace("/*",""))
            })
        }
    }, n.prototype._update = function () {
        var e = this;
        t('*[data-toggle="tooltip"]').tooltip({container: this.options.tooltip_container}), t("*[data-cal-date]").click(function () {
        ...
        if (t("a[data-event-id]", this.context).unbind("click"), e.options.modal) {
            ...
            if (a.length) {
                ...
                "iframe" == e.options.modal_type && (o = t(document.createElement("iframe")).attr({
                    ...
                    var n = t(this).attr("href"), s = t(this).data("event-id"), i = _.find(e.options.events, function (t) {
                        return t.id == s
                    });
                    "iframe" == e.options.modal_type && (o.attr("src", n), t(".modal-body", a).html(o)), (!a.data("handled.bootstrap-calendar") || a.data("handled.bootstrap-calendar") && a.data("handled.event-id") != i.id) && a.off("show.bs.modal").off("shown.bs.modal").off("hidden.bs.modal").on("show.bs.modal", function () {
                        ...
                        switch (e.options.modal_type) {
                            ...
                            case"ajax":
                                t.ajax({
                                    url: n, dataType: "html", async: !1, success: function (t) {
                                        o.html(t)
                                    }
                                });
                                break;
                            case"template":
                                e._loadTemplate("modal"), o.html(e.options.templates.modal({event: i, calendar: e}))
                        }
        ...
        if (1 == this.options.weekbox) {
            var o = t(document.createElement("div")).attr("id", "cal-week-box"), i = this.options.position.start.getFullYear() + "-" + this.options.position.start.getMonthFormatted() + "-";
            e.context.find(".cal-month-box .cal-row-fluid").on("mouseenter", function () {
                var n = new Date(e.options.position.start), s = t(".cal-cell1:first-child .cal-month-day", this), r = s.hasClass("cal-month-first-row") ? 1 : t("[data-cal-date]", s).text();
